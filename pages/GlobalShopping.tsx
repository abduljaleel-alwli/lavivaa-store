  ...
  const HERO_SLIDES = [
    {
      ...
      title: t.globalSlide1Title,
      subtitle: t.globalSlide1Sub,
      badge: t.globalBadge1
    },
    {
      image: "https://images.unsplash.com/photo-1491553895911-0055eca6402d?q=80&w=1600&auto=format&fit=crop",
      title: t.globalSlide2Title,
      subtitle: t.globalSlide2Sub,
      badge: t.globalBadge2
    },
    {
      image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=1600&auto=format&fit=crop",
      title: t.globalSlide3Title,
      subtitle: t.globalSlide3Sub,
      badge: t.globalBadge3
    }
  ];
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            {GLOBAL_STORES.map((store) => (
              <div key={store.id} className="group bg-white rounded-5xl p-8 shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-500 flex flex-col items-center text-center relative overflow-hidden">
                ...
                >
                  {t.visitStore}
                  <ExternalLink size={18} className={`transition-transform ${lang === 'en' ? 'group-hover/btn:translate-x-1' : 'group-hover/btn:-translate-x-1'}`} />
                </a>
              </div>
            ))}
         </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-4 relative">
                 <div className="flex flex-col items-center group">
                    <div className="relative mb-10">
                      <div className="w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-lg font-black text-slate-900 relative z-20 border-4 border-slate-50 transition-all group-hover:scale-110 group-hover:border-primary-vibrant group-hover:shadow-primary-vibrant/20">1</div>
                    </div>
                    ...
                    <p className="text-slate-500 font-medium text-sm leading-relaxed max-w-[240px]">{t.feature1Desc}</p>
                 </div>
                 <div className="flex flex-col items-center group">
                    <div className="relative mb-10">
                      <div className="w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-lg font-black text-slate-900 relative z-20 border-4 border-slate-50 transition-all group-hover:scale-110 group-hover:border-blue-500 group-hover:shadow-blue-500/20">2</div>
                    </div>
                    ...
                    <p className="text-slate-500 font-medium text-sm leading-relaxed max-w-[240px]">{t.feature2Desc}</p>
                 </div>
                 <div className="flex flex-col items-center group">
                    <div className="relative mb-10">
                      <div className="w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-lg font-black text-slate-900 relative z-20 border-4 border-slate-50 transition-all group-hover:scale-110 group-hover:border-accent-vibrant group-hover:shadow-accent-vibrant/20">3</div>
                    </div>
                    ...
                    <p className="text-slate-500 font-medium text-sm leading-relaxed max-w-[240px]">{t.feature3Desc}</p>
                 </div>
              </div>
            </div>
         </div>
