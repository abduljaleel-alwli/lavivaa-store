...
export const Home: React.FC = () => {
  ...
  // تم التعديل لعرض 8 منتجات (صفين) بدلاً من 4
    ...
    <div className="animate-fade-in space-y-24 pb-20">
      ...
      <section className="relative pt-10 pb-20 md:pt-20 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            {/* Left Content */}
            <div className="lg:w-1/2 z-10 text-center lg:text-right">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-bold mb-8 animate-fade-in">
                <Sparkles size={16} />
                <span>مرحباً بك في عالم الفخامة</span>
              </div>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-slate-900 leading-[1.4] mb-8" style={{lineHeight: 1.3}}>
                تسوق <span className="text-primary underline decoration-accent underline-offset-8">المحلي</span> <br />
                بلمسة <span className="text-accent">عالمية</span>
              </h1>
              <p className="text-slate-500 text-xl mb-12 leading-relaxed max-w-2xl mx-auto lg:ml-0 font-medium">
                اكتشف مجموعتنا المختارة بعناية من أفضل المتاجر المحلية، وانطلق لاستكشاف العروض العالمية المذهلة.
              </p>
              ...
              {/* Stats/Trust Bar */}
              <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 max-w-2xl mx-auto lg:mx-0">
                <div className="animate-fade-in-up delay-100 group flex items-center gap-4 bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">دعم فني</span>
                  </div>
                </div>
                ...
                <div className="animate-fade-in-up delay-200 group flex items-center gap-4 bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">أصالة المنتجات</span>
                  </div>
                </div>
                ...
                <div className="animate-fade-in-up delay-300 group flex items-center gap-4 bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">متجر عالمي</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 relative h-[600px] w-full hidden md:block">
              <div className="absolute top-0 right-0 w-[80%] h-[90%] rounded-5xl overflow-hidden shadow-2xl border-8 border-white">
              ...
              <div className="absolute bottom-4 left-0 w-[60%] aspect-square rounded-5xl overflow-hidden shadow-2xl border-8 border-white -translate-y-12">
              ...
              <div className="absolute top-1/2 left-0 transform -translate-x-1/4 bg-white p-8 rounded-4xl shadow-2xl border border-slate-100 max-w-[240px] animate-bounce-slow">
                ...
                <h4 className="font-black text-xl text-slate-900 mb-2">تخفيضات كبرى</h4>
                <p className="text-slate-500 text-sm font-bold">خصم يصل إلى 50% على قطع مختارة من المتاجر المحلية.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            ...
            <p className="text-slate-500 font-medium text-lg">كل ما تحتاجه في مكان واحد، مقسم بعناية لراحتك.</p>
          </div>
          ...
          {CATEGORIES.map((cat, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-8 right-8 text-white">
                ...
                <span className="text-sm font-bold opacity-80">{cat.itemCount} منتج</span>
              </div>
            </Link>
          ))}
        </div>
      ...
      <section className="bg-slate-50 py-24">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-500 font-medium text-lg">القطع الأكثر طلباً وتميزاً لهذا الأسبوع في متجرنا المحلي.</p>
          </div>
      ...
      <section className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">ما يميزنا في <span className="text-primary">LAVIVAA</span></h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 text-center">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">شحن سريع</h3>
            <p className="text-slate-500 font-medium leading-relaxed">توصيل سريع وآمن لجميع المناطق خلال وقت قياسي.</p>
          </div>
          ...
          <div className="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 text-center">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">دفع آمن</h3>
            <p className="text-slate-500 font-medium leading-relaxed">خيارات دفع متعددة مع حماية كاملة لبياناتك.</p>
          </div>
          ...
          <div className="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 text-center">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">استرجاع سهل</h3>
            <p className="text-slate-500 font-medium leading-relaxed">إمكانية الإرجاع والاستبدال بسهولة ومرونة.</p>
          </div>
          ...
          <div className="group bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 text-center">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">تغليف فاخر</h3>
            <p className="text-slate-500 font-medium leading-relaxed">تغليف أنيق وجذاب مثالي للهدايا والمناسبات.</p>
          </div>
        </div>
      </section>


      {/* Why Us Section - Vibrant Features */}
      <section className="container mx-auto px-4 mb-20">
        <div className="bg-primary rounded-5xl p-10 md:p-20 text-white relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              <h2 className="text-4xl md:text-5xl font-black mb-8 leading-tight" style={{ lineHeight: 1.3 }}>نسعى لتقديم تجربة تسوق تفوق التوقعات</h2>
              <p className="text-white/70 text-lg font-medium leading-relaxed mb-12">
                منذ بدايتنا، هدفنا هو جسر الهوة بين التسوق المحلي بجودته العالية والتسوق العالمي بتنوعه الهائل.
              </p>
              <div className="space-y-6">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-xl">أمان تام</h4>
                    <p className="text-white/60 text-sm mt-1">عمليات دفع مشفرة وآمنة بنسبة 100%.</p>
                  </div>
                </div>
                <div className="flex items-center gap-5">
                  <div className="w-14 h-14 rounded-2xl bg-accent flex items-center justify-center shadow-lg text-primary"><Zap size={28} /></div>
                  <div>
                    <h4 className="font-bold text-xl">سرعة فائقة</h4>
                    <p className="text-white/60 text-sm mt-1">توصيل محلي في زمن قياسي وروابط عالمية مباشرة.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 bg-white text-slate-900 p-8 rounded-4xl shadow-2xl border border-slate-100 max-w-[200px] -rotate-3 hidden md:block">
                <span className="text-4xl font-black text-primary block mb-1">+10k</span>
                <span className="text-sm font-bold text-slate-400">عميل سعيد يثق بنا دائماً.</span>
              </div>
            </div>
          </div>
        </div>
