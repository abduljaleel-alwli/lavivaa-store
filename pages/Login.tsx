    ...
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row animate-fade-in overflow-hidden">
      ...
      <div className="lg:w-1/2 relative hidden lg:block bg-primary overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
           <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1200" alt="Auth context" className="w-full h-full object-cover grayscale" />
      ...
      <div className="lg:w-1/2 w-full flex flex-col justify-center items-center p-6 md:p-12 lg:p-20 bg-white relative">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10">
            <h2 className="text-3xl font-black text-slate-900 mb-2">{t.login}</h2>
            <p className="text-slate-400 font-medium">
              {t.dontHaveAccount} 
              <Link to="/signup" className="text-primary font-black hover:underline mx-2">{t.signupNow}</Link>
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
             ...
             <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center gap-3 border-2 border-slate-100 py-3 rounded-2xl hover:bg-slate-50 transition-all font-bold text-sm">
                   <img src="https://www.svgrepo.com/show/355037/google.svg" alt="Google" className="h-5 w-5" /> Google
                </button>
                <button className="flex items-center justify-center gap-3 border-2 border-slate-100 py-3 rounded-2xl hover:bg-slate-50 transition-all font-bold text-sm">
                   <img src="https://www.svgrepo.com/show/303114/facebook-3.svg" alt="Facebook" className="h-5 w-5" /> Facebook
                </button>
             </div>
          </div>
        </div>
